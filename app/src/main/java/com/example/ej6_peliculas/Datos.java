...
//        }
    ...
    public ArrayList<com.example.ej6_peliculas.Pelicula> rellenaPeliculas(){
        
        ArrayList<com.example.ej6_peliculas.Pelicula> peliculas = new ArrayList<com.example.ej6_peliculas.Pelicula>();

        Calendar cal = Calendar.getInstance();
        cal.set(1982,12,3);
        com.example.ej6_peliculas.Pelicula dune=new com.example.ej6_peliculas.Pelicula("Dune","Lynch",180,cal.getTime(),"Gran vía",R.drawable.g,R.drawable.dune );
        ...
        cal.set(1972,3,5);
        com.example.ej6_peliculas.Pelicula a2001=new com.example.ej6_peliculas.Pelicula("2001","Kubric",130,cal.getTime(),"Plaza elíptica",R.drawable.pg,R.drawable.d2001 );
        ...
        cal.set(1984,11,2);
        com.example.ej6_peliculas.Pelicula akira=new com.example.ej6_peliculas.Pelicula("Akira","Otomo",170,cal.getTime(),"Gran vía",R.drawable.pg13,R.drawable.akira );
        ...
        cal.set(1995,1,2);
        com.example.ej6_peliculas.Pelicula ia=new com.example.ej6_peliculas.Pelicula("IA","Spielberg",140,cal.getTime(),"Travesia",R.drawable.r,R.drawable.ia );
        ...
        cal.set(1999,6,23);
        com.example.ej6_peliculas.Pelicula matrix=new com.example.ej6_peliculas.Pelicula("Matrix","Lana Wachowski, Lilly Wachowski",136,cal.getTime(),"Gran vía",R.drawable.pg13,R.drawable.matrix );
        ...
        cal.set(1982,8,21);
        com.example.ej6_peliculas.Pelicula br=new com.example.ej6_peliculas.Pelicula("Blade Runner","Ridley Scott",117,cal.getTime(),"Plaza elíptica",R.drawable.pg,R.drawable.blade );
        ...
        cal.set(1995,1,2);
        com.example.ej6_peliculas.Pelicula inte=new com.example.ej6_peliculas.Pelicula("Interstellar","Christopher Nolan ",169,cal.getTime(),"Travesia",R.drawable.g,R.drawable.interstellar );
        ...
        cal.set(1995,1,2);
        com.example.ej6_peliculas.Pelicula alien=new com.example.ej6_peliculas.Pelicula("Alien","Ridley Scott",117,cal.getTime(),"Plaza elíptica",R.drawable.pg13,R.drawable.alien );
        ...
        cal.set(1995,1,2);
        com.example.ej6_peliculas.Pelicula st=new com.example.ej6_peliculas.Pelicula("Star Trek","J. J. Abrams",128,cal.getTime(),"Travesia",R.drawable.pg,R.drawable.startrek);
        ...
        cal.set(2015,9,24);
        com.example.ej6_peliculas.Pelicula martian=new com.example.ej6_peliculas.Pelicula("The Martian","Ridley Scotts",151,cal.getTime(),"Gran vía",R.drawable.pg13,R.drawable.martian);
